...
//           // Process enrollments based on the combined list of courses
//           // const allCourseIds = Array.from(courseIdToCollegeIdMap.keys());
//           // const enrollmentsByCollege = new Map(
//           //   collegeIds.map((id) => [id, new Set()])
//           // );
...
//           //     const collegeId = courseIdToCollegeIdMap.get(enrollment.courseId);
//           //     if (collegeId && enrollmentsByCollege.has(collegeId)) {
//           //       enrollmentsByCollege.get(collegeId).add(enrollment.studentId);
//           //     }
//           //   }
//           // }

//           const collegeCoursesMap = coursesByCollege.get(c.id) || new Map();
//           const collegeCourseIds = Array.from(collegeCoursesMap.keys());
//           let enrolledStudentsSet = new Set();
//           if (collegeCourseIds.length > 0 && studentIds.length > 0) {
//             const collegeEnrollments = await prisma.enrollment.findMany({
//               where: {
//                 courseId: { in: collegeCourseIds },
...
//       // UPDATED: Fetch BOTH direct courses and assigned courses
//       const [directCourses, assignedCourses] = await Promise.all([
//         prisma.course.findMany({
//           where: { collegeId: id },
//           select: {
...
//       // Add assigned courses (overwrites duplicates)
//       for (const assigned of assignedCourses) {
//         courseMap.set(assigned.course.id, {
//           ...assigned.course,
//           departmentId: assigned.departmentId,
